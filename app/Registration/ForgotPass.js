...
const ForgotPass = () => {
    const [path, setPath] = useState('/Registration/ForgotPass')
    ...
    return (
        <SafeAreaView style={styles.container}>
            <View>
                ...
                <Text style={styles.text}>تم إرسال رسالة تحتوي على رمز  إلى هاتفك، يرجى إدخال هذا الرمز لتأكيد البريد الالكتروني.</Text>
            </View>
            <View>
                <TextInput 
